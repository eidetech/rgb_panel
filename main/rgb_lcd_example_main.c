...
#define EXAMPLE_PIN_NUM_DATA0          20 // B0
#define EXAMPLE_PIN_NUM_DATA1          19 // B1
#define EXAMPLE_PIN_NUM_DATA2          8  // B2
#define EXAMPLE_PIN_NUM_DATA3          16 // B3
#define EXAMPLE_PIN_NUM_DATA4          15 // B4
#define EXAMPLE_PIN_NUM_DATA5          48 // G0
#define EXAMPLE_PIN_NUM_DATA6          47 // G1
#define EXAMPLE_PIN_NUM_DATA7          21 // G2
#define EXAMPLE_PIN_NUM_DATA8          9  // G3
#define EXAMPLE_PIN_NUM_DATA9          46 // G4
#define EXAMPLE_PIN_NUM_DATA10         3  // G5
#define EXAMPLE_PIN_NUM_DATA11         38 // R0
#define EXAMPLE_PIN_NUM_DATA12         37 // R1
#define EXAMPLE_PIN_NUM_DATA13         36 // R2
#define EXAMPLE_PIN_NUM_DATA14         35 // R3
...
void app_main(void)
{
    ...
    assert(buf2);
    // initialize LVGL draw buffers
    lv_disp_draw_buf_init(&disp_buf, buf1, buf2, EXAMPLE_LCD_H_RES * 40000);
#endif // CONFIG_EXAMPLE_DOUBLE_FB
